...
//    static IEngine dbEngine = new SkipHashEngine();
    ...
    public static void evaluateInsert() {
        ...
        System.out.println(
            "Time taken for " + numberOfInserts + " INSERT operations: " + elapsedTimeInSeconds
                + " seconds");
    ...
    public static void evaluateSelect() {
        ...
        double elapsedTimeInSeconds = (stopTime - startTime) / 1_000_000_000.0;
        System.out.println(
            "Time taken for " + numberOfSelects + " SELECT operations: " + elapsedTimeInSeconds
                + " seconds");
        dbEngine = new BPlusTreeEngine(false);
    }
    ...
    public static void evaluateUpdate() {
        ...
        double elapsedTimeInSeconds = (stopTime - startTime) / 1_000_000_000.0;
        System.out.println(
            "Time taken for " + numberOfUpdates + " UPDATE operations: " + elapsedTimeInSeconds
                + " seconds");
        dbEngine = new BPlusTreeEngine(false);
    }
    ...
    public static void evaluateDelete() {
        ...
        double elapsedTimeInSeconds = (stopTime - startTime) / 1_000_000_000.0;
        System.out.println(
            "Time taken for " + numberOfDeletes + " DELETE operations: " + elapsedTimeInSeconds
                + " seconds");
        dbEngine = new BPlusTreeEngine(false);
    }
    ...
    public static void autoEvaluate() {
        ...
        for (int i = 0; i < numberOfQueries; i++) {
            ...
            if (i % 10000 == 0) {
                ...
                queryTime /= 1000;
                System.out.println(
                    "Processed " + i + " queries..." + " Time taken for 10k(s): " + queryTime
    ...
    private static void prepopulateTables(Random random) {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            String insertCommand = String.format("INSERT INTO users VALUES (%d, '%s', %d, '%s')", i,
                name, age, city);
        ...
        for (int i = 0; i < 50; i++) {
            ...
            String insertCommand = String.format(
                "INSERT INTO products VALUES (%d, '%s', %.2f, '%s')", i, productName, price,
                category);
            dbEngine.executeSQL(insertCommand);
        }
        ...
        for (int i = 0; i < 50; i++) {
            ...
            String category = getRandomCategory(random);
            String insertCommand = String.format("INSERT INTO orders VALUES (%d, %d, %d, %d)", i,
        ...
        switch (tableChoice) {
            case 0: // Insert into users table
                ...
                String insertUserQuery =
                    "INSERT INTO users VALUES (" + id + ", '" + name + "', " + age + ", '" + city
                        + "')";
            ...
            case 2: // Insert into orders table
                ...
                String insertOrderQuery =
                    "INSERT INTO orders VALUES (" + orderId + ", " + userId + ", " + productIdRef
                        + ", " + quantity + ")";
    ...
    private static void complexSelectQuery(Random random) {
        ...
        switch (tableChoice) {
            ...
            case 2: // Complex SELECT on products
                ...
                String category = getRandomCategory(random);
                complexSelectQuery =
                    "SELECT * FROM products WHERE price > " + minPrice2 + " AND category = "
                        + category;
                break;
            default:
        ...
        switch (tableChoice) {
            case 0: // Complex UPDATE on users
                ...
                String updateUserQuery =
                    "UPDATE users SET age = " + newAge + " WHERE city = '" + city + "'";
                dbEngine.executeSQL(updateUserQuery);
                break;
